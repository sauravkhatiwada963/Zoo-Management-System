...
<head>
	...
	<!-- Theme JS files -->
	<script type="text/javascript" src="../../dashboardresources/assets/js/plugins/notifications/pnotify.min.js"></script>
...
function loadarchiveanimaltemp(){
	$.ajax({
		url:"../admin/archiveanimaltemp.php",
		method:"POST",
		success:function(data){
			$('.changingmain').html(data);
...
function loadViewdWatchlistTemp(){
	$.ajax({
			url:"../admin/viewwatchlisttemp.php",
			method:"POST",
			success:function(data)
			{
				$('.changingmain').html(data);
...
$.ajax({
	url:"../admin/completewatchlisttemp.php",
	method:"POST",
	success:function(data){
		$('.changingmain').html(data);
...
function loadviewanimalimagestemp(){
	...
	$.ajax({
		url:"../admin/viewanimalimagestemp.php",
		method:"POST",
		success:function(data){
			$('.changingmain').html(data);
...
function  loadviewarchivedimages(){
	$.ajax({
		url:"../admin/archiveimagetemp.php",
		method:"POST",
		success:function(data){
			$('.changingmain').html(data);
